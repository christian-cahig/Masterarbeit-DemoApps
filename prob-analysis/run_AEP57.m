...
multPds = normrnd(1, MUL_STD_DEV, NUM_SAMPLES, 1);
multQds = normrnd(1, MUL_STD_DEV, NUM_SAMPLES, 1);
...
parfor i = 1:NUM_SAMPLES
    ...
    ddata = makeDispData(bdata, MPOptions=mpopt, ...
        PdScaleRange=[multPds(i), multPds(i)], ...
        QdScaleRange=[multQds(i), multQds(i)], ...
...
save(sprintf("./%s.mat", fname), ...
    ...
    "meanPds", "meanQds", "multPds", "multQds", ...
    "uuFeasi", "uuAPFOk", ...
    "uuPus", "uuQus", "uuVms", "uuVas", "uuPs", ...
    "urFeasi", "urAPFOk", ...
    "urPus", "urQus", "urVms", "urVas", "urPs", ...
    "ruFeasi", "ruAPFOk", ...
    "ruPus", "ruQus", "ruVms", "ruVas", "ruPs", ...
    "rrFeasi", "rrAPFOk", ...
    "rrPus", "rrQus", "rrVms", "rrVas", "rrPs");
